...
\definecolor{FormalDarkBlue}{RGB}{10,40,90}  
\setbeamercolor{section title}{bg=FormalDarkBlue, fg=white}
...
\begin{frame}{Fuzzy-join configuration }
	 \begin{tabular}{ccc}  
		\begin{tabular}{c}
			\includegraphics[width=0.2\linewidth]{img/img-fuzzyjoin-config-1.png}
		\end{tabular}
		& \begin{tabular}{l}
			\includegraphics[width=0.2\linewidth]{img/img-fuzzyjoin-config-2.png}
		\end{tabular}	
		& \begin{tabular}{l}
		\includegraphics[width=0.2\linewidth]{img/img-fuzzyjoin-config-3.png}
		\end{tabular}  \\
	\end{tabular}
